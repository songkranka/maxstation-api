...
namespace MasterData.API.Extensions
{
    public static class MiddlewareExtensions
    {
        ...
        public static IApplicationBuilder UseCustomSwagger(this IApplicationBuilder app)
        {
            ...
            //var path = (!env.IsProduction()) ? "" : "/masterdata";
            app.UseSwagger().UseSwaggerUI(options =>
            {
                //options.SwaggerEndpoint($"{path}/swagger/v1/swagger.json", "MasterData API");
                //options.DocumentTitle = $"MasterData API";

                options.SwaggerEndpoint($"{rootUrl}/swagger/v1/swagger.json", "MasterData API");
                options.DocumentTitle = $"MasterData API";
            });
            return app;
        }
