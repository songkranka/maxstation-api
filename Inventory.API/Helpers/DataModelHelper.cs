...
namespace Inventory.API.Helpers
{
    ...
    {
        public T CreateObject<T>(DataTable dataTable)
        {
            try
            {
        ...
        public T CreateObject<T>(IDataReader dataRender)
        {
            dataRender.Read();
        ...
        public List<T> CreateList<T>(DataTable dataTable)
        {
            Type ItemType = typeof(T);
        ...
        public List<T> CreateList<T>(IDataReader dataReader)
        {
        ...
        public string MapDocStatusTHToEN(string docStatus)
        {
            switch (docStatus)
            {
                case "แอคทีฟ":
