...
namespace Finance.API.Extensions
{
    public static class MiddlewareExtensions
    {
        ...
        public static IApplicationBuilder UseCustomSwagger(this IApplicationBuilder app)
        {
            ...
            //var path = (!env.IsProduction()) ? "" : "/finance";
            app.UseSwagger().UseSwaggerUI(options =>
            {
                //options.SwaggerEndpoint($"{path}/swagger/v1/swagger.json", "Finance API");
                //options.DocumentTitle = "Finance API";

                options.SwaggerEndpoint($"{rootUrl}/swagger/v1/swagger.json", "Finance API");
                options.DocumentTitle = $"Finance API";
